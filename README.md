...
1. Add a new book:
    ```bash
    curl -X POST http://127.0.0.1:8080/books -d '{"title":"Book Title", "author":"Author Name"}' -H "Content-Type: application/json"
    ```
...
3. Update a book:
    ```bash
    curl -X PUT http://127.0.0.1:8080/books -d '{"id":"<book_id>", "title":"Updated Title", "author":"Updated Author"}' -H "Content-Type: application/json"
    ```

4. Remove a book:
    ```bash
    curl -X DELETE http://127.0.0.1:8080/books -d '{"id":"<book_id>"}' -H "Content-Type: application/json"
    ```
